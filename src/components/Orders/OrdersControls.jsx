...
//   // Достаем метаданные с ошибками из Redux
...
//   // Определяем глобальные состояния для иконки кнопки
...
//                 // В выпадающем списке тоже можно отобразить ошибку,
//                 // но пока оставим минималистично, опираясь на счетчики
//                 const isFailed =
//                   isSucceeded &&
...
//                     >
//                       {isFailed ? 'Ошибка' : countsBySupplier.get(key) || 0}
//                     </Typography>
//                   </MenuItem>
//                 );
//               })}
...
//         {/* 2. Панель активных чипов с визуализацией успеха/ошибок */}
...
//                 (f) => f.name === key
//               );
//               const hasData = (countsBySupplier.get(key) || 0) > 0;
...
//                   chipColor = 'error';
//                   chipVariant = 'filled';
//                   tooltipTitle = `Ошибка парсинга: ${failedInfo.reason}`;
//                 } else if (hasData) {
//                   chipColor = 'success';
//                   chipVariant = 'filled';
//                   tooltipTitle = `Успешно загружено: ${countsBySupplier.get(key)} шт.`;
//                 } else {
//                   chipColor = 'default';
//                   chipVariant = 'outlined';
//                   tooltipTitle = 'Заказов не найдено';
//                 }
//               }
